            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:support@ecommerce.com" className="text-blue-600 hover:text-blue-700 font-medium text-sm">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mb-2">Lun-Ven 9h-18h</p>
                  <a href="tel:+33123456789" className="text-blue-600 hover:text-blue-700 font-medium text-sm">
                    +33 1 23 45 67 89
                  </a>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mb-2">Siège social</p>
